<template>
    <nav class="navbar navbar-expand-lg bg-info shadow p-3">
                ...
                <ul class="navbar-nav ms-auto">
                    ...
                    <li class="nav-item dropdown">
                        ...
                        <ul class="dropdown-menu">
                            <li><nuxt-link to="/profile/identitasSekolah" class="dropdown-item">Identitas Sekolah</nuxt-link></li>
                    ...
                    <li class="nav-item">
                            <nuxt-link to="/kurikulum/konsentrasiKeahlian" class="nav-link active" aria-current="page">Konsentrasi Keahlian</nuxt-link>
                    </li>
                    <li class="nav-item dropdown">
                        <a class="nav-link dropdown-toggle" role="button" data-bs-toggle="dropdown" aria-expanded="false">
                            Kesiswaan
